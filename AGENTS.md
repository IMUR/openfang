...
| `docs/architecture/memory-intelligence.md` | Current memory architecture dimensions: substrate, data model, contract, intelligence |
...
10. **Standard build for this deployment** (Candle memory pipeline active):
  ...
  ```
11. **Memory architecture vocabulary:** Use the dimensions framework in `docs/architecture/memory-intelligence.md`: every memory surface is described by substrate, data model, contract, and intelligence. Multi-value placements are expected. Avoid reintroducing the old Layer 1/2/3 terminology in new docs.
